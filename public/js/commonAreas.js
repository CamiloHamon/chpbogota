...
const fetchAllData = async () => {
    ...
    try {
        const response = await fetch('/api/common-areas'); // Asegúrate de que esta ruta sea correcta
        ...
        hideLoading();
        console.error('Error al obtener los datos de áreas comunes:', error);
        return [];
    }
};

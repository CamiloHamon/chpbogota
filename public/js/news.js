        ...
        <div class="share-buttons">
          ...
          <div class="share-buttons-content">
            ...
            ${images[2]}
             ...
             <a href="${linkedinShareURL}" class="share-btn linkedin" target="_blank" title="Compartir en LinkedIn">
            ${images[3]}
            </a>
          </div>
        </div>
